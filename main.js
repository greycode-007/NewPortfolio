...
function portfolioItemDetails(portfolioItem) {
  const img = document.querySelector(".pp-thumbnail img");
  ...
  if (img && portfolioItem.querySelector(".work-img")) {
    img.src = portfolioItem.querySelector(".work-img").src;
  }
  if (subtitle && portfolioItem.querySelector(".work-title")) {
    subtitle.innerHTML = portfolioItem.querySelector(".work-title").innerHTML;
  }
  if (body && portfolioItem.querySelector(".portfolio-item-details")) {
...
if (typeof Swiper !== 'undefined' && document.querySelector('.testimonials-container')) {
